...
function editörMessages() {
    ...
    const getMessages = async () => {
        ...
        const filterData = data.data.filter(da => da.president == false && da.completed == false)
    ...
    return (
        <div className="editör-messages-container ">
            <div className="container editör-message-container">
                <img className='editör-message-paper' src={imageUrl + messageImage} alt="" />
